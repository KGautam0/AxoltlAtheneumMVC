...
INSERT INTO `shopping_carts` VALUES ('2368',123,1,20),('2368',123,1,20);
...
CREATE TABLE `users` (
  ...
  `card` varchar(4000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES ('749','John','Doe','1234567890','books.r.pog@gmail.com','123',3,'{\"Street\":\"Fake Street\",\"Street2\":null,\"City\":\"Fake City\",\"State\":2,\"Zip\":\"30064\"}','{\"cardNumber\":\"7777777777777777\",\"cardSecNumber\":\"777\",\"cardType\":0,\"expMonth\":\"10\",\"expYear\":\"2021\"}',313,1),(NULL,'Danny','Mossman','3333333333','dannymoss@gmail.com','supersecret',1,'null','null',780,0),(NULL,'Jill','Johnny','1234567890','happyjill@gmail.com','supersecret',1,'null','null',87,0),('2368','Megan','Jimenez','1234567890','meganicolej@gmail.com','123',2,'null','null',259,0),('123','Megan','J','1234567890','test@ax.co','123',2,'',NULL,123,1),(NULL,'David','Hasslehoff','0987654321','thehoff@gmail.com','supersecret',1,'null','null',596,0);
...
THEN
	...
	Values (p_firstName, p_lastName, p_phonenumber, p_email, p_Password, p_Status, p_Address, p_Card, p_Actnum , 0 );
END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
	...
	UPDATE Users SET firstname=p_firstName, lastname = p_lastName, password = p_Password,
	status = p_Status, address = p_Address, card = p_Card, actnum = p_Actnum, isAdmin = p_isAdmin, phonenumber = p_phonenumber, userID= p_userID
	WHERE email = p_email;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2021-08-01 23:45:00
