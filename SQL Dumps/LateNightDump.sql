...
INSERT INTO `users` VALUES ('749','John','Doe','1234567890','books.r.pog@gmail.com',_binary '123',3,'{\"Street\":\"Fake Street\",\"Street2\":null,\"City\":\"Fake City\",\"State\":2,\"Zip\":\"30064\"}',_binary '{\"cardNumber\":\"7777777777777777\",\"cardSecNumber\":\"777\",\"cardType\":0,\"expMonth\":\"10\",\"expYear\":\"2021\"}',313,NULL,NULL,NULL),(NULL,'Danny','Mossman','3333333333','dannymoss@gmail.com',_binary 'supersecret',1,'null',_binary 'null',780,NULL,NULL,NULL),(NULL,'Jill','Johnny','1234567890','happyjill@gmail.com',_binary 'supersecret',1,'null',_binary 'null',87,NULL,NULL,NULL),('2368','Megan','Jimenez','1234567890','meganicolej@gmail.com',_binary '123',2,'{\"Street\":\"123 rd\",\"Street2\":null,\"City\":\"ws\",\"State\":0,\"Zip\":\"12345\"}','',259,'','',1),('123','Megan','J','1234567890','test@ax.co',_binary '123',2,'',NULL,123,NULL,NULL,NULL),(NULL,'David','Hasslehoff','0987654321','thehoff@gmail.com',_binary 'supersecret',1,'null',_binary 'null',596,NULL,NULL,NULL);
...
THEN
	...
	INSERT INTO Users ( firstname, lastname, phonenumber, email, userID, password, status, address, card0, card1, card2, actnum, isSubscribed )
	
	Values (p_firstName, p_lastName, p_phonenumber, p_email, p_userID, aes_encrypt(p_password, 'keystring'), p_Status, p_Address, aes_encrypt(p_Card0, 'keystring'), aes_encrypt(p_Card1, 'keystring'), aes_encrypt(p_Card2, 'keystring'), p_Actnum , 0 );
END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2021-08-06  2:35:10
