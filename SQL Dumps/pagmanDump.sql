...
--
-- Host: localhost    Database: pogstore
-- ------------------------------------------------------
...
INSERT INTO `shopping_carts` VALUES ('2368',12346,1,50);
...
CREATE TABLE `users` (
  ...
  `card0` varbinary(4000) DEFAULT NULL,
  `actnum` int DEFAULT NULL,
  `card2` varbinary(4000) DEFAULT NULL,
  `card1` varbinary(4000) DEFAULT NULL,
  `isSubscribed` tinyint DEFAULT NULL,
  PRIMARY KEY (`email`)
...
INSERT INTO `users` VALUES ('3808','Hingle','McCringle','7777777777','books.r.pog@gmail.com',_binary '¹Z\Í\Õ8QF{Ozmqö[W\ê',2,'null',_binary '6¤Î¦\Ù\Ã\á÷\ÙNƒ\n†¾',664,_binary '6¤Î¦\Ù\Ã\á÷\ÙNƒ\n†¾',_binary '6¤Î¦\Ù\Ã\á÷\ÙNƒ\n†¾',0),(NULL,'Danny','Mossman','3333333333','dannymoss@gmail.com',_binary 'supersecret',1,'null',_binary 'null',780,NULL,NULL,NULL),(NULL,'Jill','Johnny','1234567890','happyjill@gmail.com',_binary 'supersecret',1,'null',_binary 'null',87,NULL,NULL,NULL),('2368','Megan','Jimenez','1234567890','meganicolej@gmail.com',_binary '123',2,'{\"Street\":\"123 rd\",\"Street2\":null,\"City\":\"ws\",\"State\":0,\"Zip\":\"12345\"}','',259,'','',1),('123','Megan','J','1234567890','test@ax.co',_binary '123',2,'',NULL,123,NULL,NULL,NULL),(NULL,'David','Hasslehoff','0987654321','thehoff@gmail.com',_binary 'supersecret',1,'null',_binary 'null',596,NULL,NULL,NULL);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'pogstore'
--
...
BEGIN
	...
	SELECT email, userID, CAST(AES_Decrypt(password, 'keystring') AS CHAR) AS 'password', firstname, lastname, phonenumber, status, address, CAST(AES_Decrypt(card0, 'keystring') AS CHAR) AS 'card0',  CAST(AES_Decrypt(card1, 'keystring') AS CHAR) AS 'card1',  CAST(AES_Decrypt(card2, 'keystring') AS CHAR) AS 'card2', actnum, isSubscribed FROM users
	WHERE email=p_Email;
	LEAVE sp_lbl;
END ;;
DELIMITER ;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Create_User`(
	...
	p_Card0 nvarchar(4000),
    p_Card1 nvarchar(4000),
    p_Card2 nvarchar(4000),
	p_Actnum smallint)
BEGIN
IF NOT EXISTS (SELECT 1 FROM Users WHERE email = p_email)
THEN
	
	INSERT INTO Users ( firstname, lastname, phonenumber, email, password, status, address, card0, card1, card2, actnum, isSubscribed )
	
	Values (p_firstName, p_lastName, p_phonenumber, p_email, aes_encrypt(p_password, 'keystring'), p_Status, p_Address, aes_encrypt(p_Card0, 'keystring'), aes_encrypt(p_Card1, 'keystring'), aes_encrypt(p_Card2, 'keystring'), p_Actnum , 0 );
END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_books`(p_ISBN nvarchar(20))
BEGIN
SELECT * FROM books
WHERE ISBN = p_ISBN;
END ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_cartbooks` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_cartbooks`( p_userID nvarchar(20))
BEGIN
...
BEGIN
	...
	UPDATE Users SET  password = aes_encrypt(p_Password, 'keystring')
	WHERE email = p_email;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `returnSubbedUsers` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `returnSubbedUsers`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_user`( 
    ...
    p_Card2 nvarchar(4000),
	p_Actnum smallint,
	p_isSubscribed tinyint unsigned,
	p_phonenumber nvarchar(10))
BEGIN
	UPDATE Users SET firstname=p_firstName, lastname = p_lastName, password = AES_ENCRYPT(p_Password, 'keystring'), 
	status = p_Status, address = p_Address, card0 = AES_ENCRYPT(p_Card0, 'keystring'), card1 = AES_ENCRYPT(p_Card1, 'keystring'), card2 = AES_ENCRYPT(p_Card2, 'keystring'), actnum = p_Actnum, isSubscribed = p_isSubscribed, phonenumber = p_phonenumber, userID= p_userID
	WHERE email = p_email;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2021-08-06 11:13:51
